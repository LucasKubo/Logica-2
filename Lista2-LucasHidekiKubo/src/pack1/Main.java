...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Valor sem formatação: ".toUpperCase() + mes1.getValor());
		System.out.println("Valor com formatação: ".toUpperCase()  + mes1.getValorFormatado());
		...
		System.out.println("Horário da validade do boleto: ".toUpperCase() + mes1.getHorarioValidadeDoBoleto());
	}
